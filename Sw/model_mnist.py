...
# Hàm xử lý ảnh vẽ sang kích thước 32x32 và chuẩn hóa
def process_drawing(drawing):
    ...
    if contours:
        ...
        # Resize giữ tỷ lệ trong vùng 20x20
        if h > w:
    ...
    # Resize lên 32x32, reshape và chuẩn hóa
...
class DigitDrawer:
    def __init__(self):
        ...
        self.model.load_weights('Sw\mnist_quantized_weights.weights.h5')  # chỉnh path weights của bạn
        self.reset_canvas()
        self.drawing = False
