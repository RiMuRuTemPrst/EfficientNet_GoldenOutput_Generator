...
if __name__ == "__main__":
    ...
    # File paths cố định
    input_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer5_stride.hex"
    weight_file = "../Fused-Block-CNN/address/golden_full_fused/hex/weight_6.hex"
    output_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer6.hex"
    bias_file = "../Fused-Block-CNN/address/golden_full_fused/hex/bias_6.hex"
