...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_full_fused/hex/weight_out.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_full_fused/hex/weight_01_PE{pe}.hex"
