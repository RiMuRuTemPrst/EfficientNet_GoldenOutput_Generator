...
if __name__ == "__main__":
    ...
    # File paths cố định
    input_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer4_add.hex"
    weight_file = "../Fused-Block-CNN/address/golden_full_fused/hex/weight_5.hex"
    output_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer5.hex"
    bias_file = "../Fused-Block-CNN/address/golden_full_fused/hex/bias_5.hex"
