...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer8_add.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_full_fused/hex/OFM8_PE_add{pe}.hex"
