...
if __name__ == "__main__":
    ...
    # File paths cố định
    input_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer1_stride.hex"
    weight_file = "../Fused-Block-CNN/address/golden_full_fused/hex/weight_2.hex"
    output_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer2.hex"
    bias_file = "../Fused-Block-CNN/address/golden_full_fused/hex/bias_2.hex"
