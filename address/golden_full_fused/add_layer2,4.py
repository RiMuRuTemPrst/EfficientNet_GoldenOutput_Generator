...
# Gọi hàm
file1 = '../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer4.hex'
file2 = '../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer2.hex'
output = '../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer4_add.hex'
