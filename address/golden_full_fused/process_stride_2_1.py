...
def main():
    ...
    input_file = '../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer5.hex'  # Đường dẫn tới file hex đầu vào
    output_file = '../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer5_stride.hex'  # Đường dẫn tới file hex đầu ra
