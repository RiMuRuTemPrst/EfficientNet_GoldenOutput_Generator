...
if __name__ == "__main__":
    ...
    # File paths cố định
    input_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer7.hex"
    weight_file = "../Fused-Block-CNN/address/golden_full_fused/hex/weight_8.hex"
    output_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer8.hex"
    bias_file = "../Fused-Block-CNN/address/golden_full_fused/hex/bias_8.hex"
