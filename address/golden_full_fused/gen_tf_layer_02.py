...
import argparse
import math
# ===== Fixed-point constants (Q10.6 & Q2.6) ==================
FRAC_BITS      = 6
...
if __name__ == "__main__":
    ...
    # File paths cố định
    input_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer01_stride.hex"
    weight_file = "../Fused-Block-CNN/address/golden_full_fused/hex/weight_Proj1a.hex"
    output_file = "../Fused-Block-CNN/address/golden_full_fused/hex/ofm_layer02.hex"
    bias_file = "../Fused-Block-CNN/address/golden_full_fused/hex/bias_02.hex"
