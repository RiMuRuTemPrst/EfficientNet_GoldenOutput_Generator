...
if __name__ == "__main__":
    ...
    # Read data
    X = read_hex_file("../Fused-Block-CNN/address/golden_5layers_folder/hex/DW/ofm_2_stride.hex", (args.height, args.height, args.channel))
    S = read_hex_file("../Fused-Block-CNN/address/golden_5layers_folder/hex/Expand/ofm_5.hex", (1, 1, args.channel_1))
    ...
    # Write output
    write_hex_file("../Fused-Block-CNN/address/golden_5layers_folder/hex/Multiply/ofm_multiply.hex", output_data)
