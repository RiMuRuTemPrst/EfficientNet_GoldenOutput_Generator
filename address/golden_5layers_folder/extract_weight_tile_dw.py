...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_5layers_folder/hex/DW/weight_2.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_5layers_folder/hex/DW/weight2_PE{pe}.hex"
