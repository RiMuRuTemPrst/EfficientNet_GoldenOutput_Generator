...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_5layers_folder/hex/Layer6/weight_6.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_5layers_folder/hex/Layer6/weight6_PE{pe}.hex"
