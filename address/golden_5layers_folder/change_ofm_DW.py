...
def process_pe_file(pe_id, OFFSET, tile):
    input_file = f"../Fused-Block-CNN/address/golden_5layers_folder/hex/OFM2_PE{pe_id}.hex"
    output_file = f"../Fused-Block-CNN/address/golden_5layers_folder/hex/OFM2_PE{pe_id}_change.hex"
