...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_5layers_folder/hex/Expand/weight_5.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_5layers_folder/hex/Expand/weight5_PE{pe}.hex"
