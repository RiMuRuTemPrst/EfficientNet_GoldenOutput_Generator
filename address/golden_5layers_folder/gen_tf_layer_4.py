...
if __name__ == "__main__":
    ...
    # File paths cố định
    input_file = "../Fused-Block-CNN/address/golden_2layers_folder/hex/Average_Pooling/ofm_3_DUT_test.hex"
    weight_file = "../Fused-Block-CNN/address/golden_2layers_folder/hex/Reduce/weight_4.hex"
    output_file = "../Fused-Block-CNN/address/golden_2layers_folder/hex/Reduce/ofm_4.hex"
