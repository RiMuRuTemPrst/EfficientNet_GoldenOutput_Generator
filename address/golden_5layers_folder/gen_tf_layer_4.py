...
if __name__ == "__main__":
    ...
    # File paths cố định
    input_file = "../Fused-Block-CNN/address/golden_5layers_folder/hex/ofm_3.hex"
    weight_file = "../Fused-Block-CNN/address/golden_5layers_folder/hex/weight_4.hex"
    output_file = "../Fused-Block-CNN/address/golden_5layers_folder/hex/ofm_4.hex"
