...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_3layers_folder/hex/ofm_2_stride.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_3layers_folder/hex/OFM2_PE{pe}.hex"
