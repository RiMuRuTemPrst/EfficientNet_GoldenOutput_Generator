...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_3layers_folder/hex/weight_2.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_3layers_folder/hex/weight2_PE{pe}.hex"
