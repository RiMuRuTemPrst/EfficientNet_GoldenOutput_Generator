...
if __name__ == "__main__":
    ...
    # File paths cố định
    input_file = "../Fused-Block-CNN/address/golden_3layers_folder/hex/ifm.hex"
    weight_file = "../Fused-Block-CNN/address/golden_3layers_folder/hex/weight.hex"
    output_file = "../Fused-Block-CNN/address/golden_3layers_folder/hex/ofm.hex"
