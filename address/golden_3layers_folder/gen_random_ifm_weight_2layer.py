...
if __name__ == "__main__":
    ...
    save_to_hex_file(IFM ,"../Fused-Block-CNN/address/golden_3layers_folder/hex/ifm.hex")
    save_to_hex_file(Weight, "../Fused-Block-CNN/address/golden_3layers_folder/hex/weight.hex")
    save_to_hex_file(Weight_2, "../Fused-Block-CNN/address/golden_3layers_folder/hex/weight_2.hex")    
