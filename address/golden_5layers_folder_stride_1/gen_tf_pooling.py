...
if __name__ == "__main__":
    ...
    # File input/output
    input_file = "../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/DW/ofm_2.hex"
    output_file = "../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/Average_Pooling/ofm_3.hex"
