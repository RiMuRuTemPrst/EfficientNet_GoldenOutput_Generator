...
if __name__ == "__main__":
    ...
    weight_file = "../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/Last/weight_6.hex"
    output_file = "../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/Last/ofm_6.hex"
