...
def main():
    ...
    input_file = '../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/DW/ofm_2.hex'  # Đường dẫn tới file hex đầu vào
    output_file = '../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/DW/ofm_2_stride.hex'  # Đường dẫn tới file hex đầu ra
