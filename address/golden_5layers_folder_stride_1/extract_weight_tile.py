...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/Layer1/weight.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/Layer1/weight1_PE{pe}.hex"
