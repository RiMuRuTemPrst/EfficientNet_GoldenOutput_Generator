...
def process_pe_file(pe_id, OFFSET, tile):
    input_file = f"../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/DW/OFM2_PE{pe_id}.hex"
    output_file = f"../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/DW/OFM2_PE{pe_id}_change.hex"
...
def process_pe_file_all(pe_id, OFFSET, tile):
    ...
    output_file = f"../Fused-Block-CNN/address/golden_5layers_folder_stride_1/hex/DW/ofm_2_change.hex"
