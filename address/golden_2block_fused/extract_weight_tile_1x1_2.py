...
def main():
    ...
    input_file = "../Fused-Block-CNN/address/golden_2block_fused/hex/weight_4.hex"
    ...
    for pe in range(args.pe):
        output_file = f"../Fused-Block-CNN/address/golden_2block_fused/hex/weight_4_PE{pe}.hex"
