...
# Chạy cho Depthwise Layer (DW)
    for pe in range(1):  # PE0 → PE3 // Điều chỉnh số PE của mỗi lớp ở đây
        file1 = f"../Fused-Block-CNN/golden_out_fused_block/output_hex_folder/OFM2_PE0_DUT.hex"
        file2 = f"../Fused-Block-CNN/address/golden_2block_fused/hex/OFM2_PE0_change.hex"
        compare_files(file1, file2, pe_id=pe, log_file="fused_block.txt")  # Lưu log vào file riêng
