...
def main():
    ...
    input_file = '../Fused-Block-CNN/address/golden_2block_fused/hex/ofm_layer1.hex'  # Đường dẫn tới file hex đầu vào
    output_file = '../Fused-Block-CNN/address/golden_2block_fused/hex/ofm_layer1_stride.hex'  # Đường dẫn tới file hex đầu ra
